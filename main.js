...
document.getElementById('basebase10').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase10 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase11').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase11 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase12').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase12 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase13').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase13 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase14').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase14 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase15').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase15 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
document.getElementById('basebase16').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#basebase16 + label span")).backgroundColor;
  document.querySelectorAll(".base").forEach(v => v.style.fill = corselecionada);
  document.getElementById('CB').style.backgroundColor = corselecionada;
});
...
document.getElementById('carcelacarcela10').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela10 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela11').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela11 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela12').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela12 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela13').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela13 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela14').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela14 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela15').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela15 + label span")).backgroundColor;
    document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
    document.getElementById('BT').style.backgroundColor = corselecionada;
});
document.getElementById('carcelacarcela16').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#carcelacarcela16 + label span")).backgroundColor;
  document.querySelectorAll(".carcela").forEach(v => v.style.fill = corselecionada);
  document.getElementById('BT').style.backgroundColor = corselecionada;
});
...
document.getElementById('golagola10').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola10 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola11').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola11 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola12').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola12 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola13').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola13 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola14').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola14 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola15').addEventListener('click', function(e){
    corselecionada = window.getComputedStyle(document.querySelector("#golagola15 + label span")).backgroundColor;
    document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
    document.getElementById('ge').style.backgroundColor = corselecionada;
});
document.getElementById('golagola16').addEventListener('click', function(e){
  corselecionada = window.getComputedStyle(document.querySelector("#golagola16 + label span")).backgroundColor;
  document.querySelectorAll(".gola").forEach(v => v.style.fill = corselecionada);
  document.getElementById('ge').style.backgroundColor = corselecionada;
});
